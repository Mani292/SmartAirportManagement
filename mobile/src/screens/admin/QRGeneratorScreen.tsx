                    ...
                    {!qrGenerated ? (
                        <View style={styles.form}>
                            ...
                            <View style={styles.previewBox}>
                                ...
                                <Text style={styles.previewDeepLink} numberOfLines={2}>
                                    smartairport://report?terminal={terminal}&area={area}&code={locationCode}
                                </Text>
                            </View>
                        ...
                        <View style={styles.successCard}>
                            ...
                            <View style={styles.qrDataBox}>
                                ...
                                <Text style={styles.qrDataLink}>smartairport://report?terminal={qrInfo.terminal}&area={qrInfo.area}&code={qrInfo.code}</Text>
                            </View>
